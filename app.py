...
# - Cria tabelas no startup e garante usuário admin/123 se não existir.
# =============================================================================
...
async def shutdown() -> None:
    # Nada especial; engine é limpo ao encerrar o processo
    pass
...
async def get_current_user(token: str, db: AsyncSession) -> User:
    # token será injetado manualmente na rota (Authorization: Bearer ...)
